...
/// @nodoc
mixin _$JokeState {
  JokesModel get joke => throw _privateConstructorUsedError;
...
abstract class $JokeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({JokesModel joke, bool isLoading});

  $JokesModelCopyWith<$Res> get joke;
}
...
class _$JokeStateCopyWithImpl<$Res, $Val extends JokeState>
  ...
  @pragma('vm:prefer-inline')
  $JokesModelCopyWith<$Res> get joke {
    return $JokesModelCopyWith<$Res>(_value.joke, (value) {
...
class _$_JokeState implements _JokeState {
  _$_JokeState({this.joke = const JokesModel(), this.isLoading = true});
...
abstract class _JokeState implements JokeState {
  factory _JokeState({final JokesModel joke, final bool isLoading}) =
      _$_JokeState;
